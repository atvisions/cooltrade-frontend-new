export default {
  ...
  analysis: {
    ...
    please_wait: '잠시 기다려 주세요, 시간이 걸릴 수 있습니다',
  ...
  membership: {
    ...
    regular_user: '일반 사용자',
    membership_management: '회원 관리',
    current_points: '현재 포인트',
    upgrade: '업그레이드',
    renew: '갱신',
    upgrade_membership: '회원 업그레이드',
    renew_membership: '회원 갱신',
    monthly_plan: '월간 플랜',
    yearly_plan: '연간 플랜',
    monthly_description: '30일간 프리미엄 기능을 즐기세요',
    yearly_description: '365일간 프리미엄 기능을 즐기세요, 52위안 절약',
    recommended: '추천',
    select_plan: '플랜 선택',
    expires_at: '만료일',
    ...
    alipay: 'Alipay',
    bank_transfer: '은행 송금',
    wechat_friend: 'WeChat 친구',
    other: '기타',
    order_created: '주문이 성공적으로 생성되었습니다',
    payment_pending: '결제 대기 중',
    payment_success: '결제 성공',
    membership_activated: '회원이 활성화되었습니다',
    insufficient_points: '포인트 부족',
    points_required: '{points}포인트가 필요합니다',
    spend_points_to_view: '포인트를 사용하여 보기',
    view_details: '세부 정보 보기',
    premium_feature: '프리미엄 기능',
    upgrade_to_premium: '프리미엄으로 업그레이드하여 모든 기능 잠금 해제',

    // 멤버십 업그레이드 인터페이스 번역
    select_membership_plan: '멤버십 플랜을 선택하세요',
    unlock_exclusive_benefits: '독점 혜택을 잠금 해제하고 경험을 향상시키세요',
    premium_member_yearly: '프리미엄 회원 (연간)',
    days_validity: '{days}일 유효',
    plan: '플랜',
    validity_period: '유효 기간',
    instant_arrival: '즉시',
    i_agree: '다음에 동의합니다',
    user_service_agreement: '서비스 약관',
    privacy_policy_link: '개인정보 처리방침',
    and: '및',
    please_select_plan: '플랜을 선택해주세요',
    please_agree_terms: '약관에 동의해주세요',
    activate_now: '지금 활성화',
    select_payment_method: '결제 방법 선택',
    use_alipay_scan: 'Alipay로 QR 코드 스캔',
    open_alipay_scan: 'Alipay 앱을 열고 QR 코드를 스캔하여 결제를 완료하세요',
    qr_code_expires: 'QR 코드는 5분 후 만료됩니다',
    qr_code_failed: 'QR 코드 생성 실패',

    // 멤버십 업그레이드 인터페이스 추가 번역
    exclusive_benefits: '독점 혜택',
    unlimited_ai_reports: '무제한 AI 리포트',
    member_points_reward: '멤버 포인트 획득, 1:10 비율 보너스',
    unlimited_save_reports: '무제한 분석 리포트 저장',
    order_details: '주문 상세',
    amount_payable: '결제 금액',
    payment_methods: '결제 방법',
    please_select_payment_method: '결제 방법을 선택해주세요',
    order_id: '주문 번호',
    payment_amount: '결제 금액',
    checking_payment_status: '결제 상태 확인 중',
    auto_activate_after_payment: '결제 완료 후 자동 활성화',
    creating_order: '주문 생성 중...',
    confirm_payment: '결제 확인',
    discount: '할인',
    per_month: '/ 월',
    per_year: '/ 년',
    activate_plan: '플랜 활성화',
    bonus_points: '보너스 포인트',
    save_amount: '¥{amount} 절약',
    points_unit: '포인트',
    generating: '생성 중...',
    payment_success_title: '결제 성공!',
    payment_success_message: '멤버십 활성화가 완료되었습니다',
    countdown_redirect: '{seconds}초 후 프로필로 자동 이동합니다',
    go_to_profile: '지금 프로필로 이동',
    create_order_failed: '주문 생성에 실패했습니다. 다시 시도해주세요'
  },
  orders: {
    title: '내 주문',
    order_number: '주문 번호',
    ...
    repaying: '결제 처리 중...',
    no_orders: '주문 없음',
    no_orders_desc: '아직 주문 기록이 없습니다',
    go_membership: '지금 멤버십 가입',
    payment_success: '결제 성공! 멤버십이 활성화되었습니다',
    check_failed: '확인 실패, 나중에 다시 시도해주세요',
    repay_failed: '결제 실패, 나중에 다시 시도해주세요'
  }
}
