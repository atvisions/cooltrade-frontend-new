export default {
  ...
  membership: {
    ...
    alipay_description: 'Scan QR code with Alipay, secure and convenient',
    scan_alipay_qr: 'Scan QR Code with Alipay',
    alipay_scan_guide: 'Open Alipay app and scan the QR code above to complete payment',
    generating_qr_code: 'Generating QR Code...',
    payment_status_checking: 'Checking payment status, membership will be activated automatically after payment',
    customer_service: 'Customer Service',
    wechat_customer_service_guide: 'If you have any questions, please scan the QR code above to contact customer service',

    // Upgrade membership interface translations
    select_membership_plan: 'Choose Your Membership Plan',
    unlock_exclusive_benefits: 'Unlock exclusive benefits and enhance your experience',
    premium_member_yearly: 'Premium Member (Yearly)',
    days_validity: '{days} days validity',
    plan: 'Plan',
    validity_period: 'Validity Period',
    instant_arrival: 'Instant',
    i_agree: 'I have read and agree to',
    user_service_agreement: 'Terms of Service',
    ...
    use_alipay_scan: 'Scan QR Code with Alipay',
    open_alipay_scan: 'Open Alipay app and scan the QR code to complete payment',
    qr_code_expires: 'QR code expires in 5 minutes',
    qr_code_failed: 'QR code generation failed',

    // Additional translations for membership upgrade interface
    exclusive_benefits: 'Exclusive Benefits',
    unlimited_ai_reports: 'Unlimited AI Reports',
    member_points_reward: 'Earn member points, 1:10 ratio bonus',
    unlimited_save_reports: 'Unlimited Save Analysis Reports',
    ...
    auto_activate_after_payment: 'Auto activate after payment',
    ...
    payment_success_message: 'Congratulations on successfully activating your membership',
    countdown_redirect: 'Redirecting to profile in {seconds} seconds',
    go_to_profile: 'Go to Profile Now',
    create_order_failed: 'Failed to create order, please try again'
  },
  orders: {
    title: 'My Orders',
    ...
    checking: 'Checking...',
    repay: 'Pay Again',
    repaying: 'Processing Payment...',
    no_orders: 'No Orders',
    no_orders_desc: 'You have no order records yet',
    go_membership: 'Get Membership Now',
    payment_success: 'Payment successful! Membership activated',
    check_failed: 'Check failed, please try again later',
    repay_failed: 'Payment failed, please try again later'
  }
}
